...
major releases including a number of minor or bugfix releases. Also Fedora uses
...
bugfix releases on a monthly basis.
...
are restricted to new development and developers can still apply bugfixes.
