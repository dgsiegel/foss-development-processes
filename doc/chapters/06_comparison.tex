...
\begin{figure}[htbp]
  ...
  \subfloat[Drupal]
    {\includegraphics[width=.55\textwidth]{drupal/cycle}} \qquad
  \subfloat[Plone]
    {\includegraphics[width=.55\textwidth]{plone/cycle}}
  }

  \noindent\makebox[\textwidth]{
  \subfloat[Python]
    {\includegraphics[width=.55\textwidth]{python/cycle}} \qquad
  \subfloat[PHP]
    {\includegraphics[width=.55\textwidth]{php/cycle}}
  }

  \noindent\makebox[\textwidth]{
  \subfloat[GNOME]
    {\includegraphics[width=.55\textwidth]{gnome/cycle}} \qquad
  \subfloat[KDE]
    {\includegraphics[width=.55\textwidth]{kde/cycle}}
  }

  \noindent\makebox[\textwidth]{
  \subfloat[PostgreSQL]
    {\includegraphics[width=.55\textwidth]{postgresql/cycle}} \qquad
  \subfloat[MariaDB]
    {\includegraphics[width=.55\textwidth]{mariadb/cycle}}
  }

  \noindent\makebox[\textwidth]{
  \subfloat[Fedora]
    {\includegraphics[width=.55\textwidth]{fedora/cycle}} \qquad
  \subfloat[Debian]
    {\includegraphics[width=.55\textwidth]{debian/cycle}}
  }
...
\begin{figure}[ph]
  ...
  \noindent\makebox[\textwidth]{
  \subfloat[Drupal]
    {\includegraphics[width=.55\textwidth]{drupal/feature}} \qquad
  \subfloat[Plone]
    {\includegraphics[width=.55\textwidth]{plone/feature}}
  }
  ...
  \noindent\makebox[\textwidth]{
  \subfloat[Python]
    {\includegraphics[width=.55\textwidth]{python/feature}} \qquad
  \subfloat[PHP]
    {\includegraphics[width=.55\textwidth]{php/feature}}
  }
  ...
  \noindent\makebox[\textwidth]{
  \subfloat[GNOME]
    {\includegraphics[width=.55\textwidth]{gnome/feature}} \qquad
  \subfloat[KDE]
    {\includegraphics[width=.55\textwidth]{kde/feature}}
  }
  ...
  \noindent\makebox[\textwidth]{
  \subfloat[PostgreSQL]
    {\includegraphics[width=.55\textwidth]{postgresql/feature}} \qquad
  \subfloat[MariaDB]
    {\includegraphics[width=.55\textwidth]{mariadb/feature}}
  }
  ...
  \noindent\makebox[\textwidth]{
  \subfloat[Fedora]
    {\includegraphics[width=.55\textwidth]{fedora/feature}} \qquad
  \subfloat[Debian]
    {\includegraphics[width=.55\textwidth]{debian/feature}}
  }
