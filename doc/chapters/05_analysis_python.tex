...
around 1989 at the \textsmaller{CWI} Institute in the Netherlands \cite{Venners2003}. Python
was a successor to the \textsmaller{ABC} programming language, which itself saw contributions
...
\begin{enumerate}
  ...
  \item \spacedlowsmallcaps{Informational PEP} Unlike the Standards Track
    \textsmaller{PEP}, this type of \ac{PEP} does not propose a new feature. It
    ...
    and so one is free to ignore Informational \textsmaller{PEPs}.
