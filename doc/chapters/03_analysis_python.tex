...
\marginpar{\includegraphics[width=\marginparwidth]{python/logo}}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{python/commits_by_author}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{python/commits_by_year}
