...
\begin{figure}[htbp]
  ...
  \caption[Inductive process in qualitative content analysis]
...
\begin{figure}[htbp]
  ...
  {The original Waterfall software engineering model with it's implementation
...
\begin{figure}[htbp]
  ...
  {The spiral software engineering model with it's typical four step approach
...
The Scrum software engineering model was first referred by
