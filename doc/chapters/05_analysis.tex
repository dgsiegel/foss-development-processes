...
chapter will then use the proposed catalogue to analyze further projects using
a qualitative analysis. This is a good use case for \citeauthor{Mayring2000}'s
research method for qualitative content analysis described in
\autoref{chap:theoretical background}.
...
Finally there exists a Release Coordinator which normally is a captain
...
the whole \ac{API} must not be changed anymore.
