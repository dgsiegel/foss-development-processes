...
major systems such as Linux, \textsmaller{UNIX}, Microsoft Windows or Mac
\textsmaller{OS X} \cite{PostgreSQLAbout,PostgreSQLFAQ}. The group behind the
...
and therefore it is quite similar to a \textsmaller{BSD} license.
...
\textsmaller{POSTGRES} \cite{PostgreSQLHistory}. Not until 1996 it was
...
According to the project there are six core team members, 38 major contributors
...
The Commit Fests are the only possibility to add new features to the project and
...
As most of the key-authors of MySQL moved to different projects such as MariaDB
...
Conference (\textsmaller{FUDCon}) which is held annually in various places
